...
public class SwerveModule {
    ...
    // SmartDashboard.putNumber("Drive Temp Mod "+ moduleNumber,
    // mDriveMotor.getTemperature());
    // SmartDashboard.putNumber("Steer Temp Mod "+ moduleNumber,
    // mAngleMotor.getTemperature());
    // }
    ...
    private void setSpeed(SwerveModuleState desiredState, boolean isOpenLoop) {
        if (isOpenLoop) {
            ...
            double velocity = Conversions.MPSToFalcon(desiredState.speedMetersPerSecond,
                    SwerveConstants.WHEEL_CIRCUMFRENCE, SwerveConstants.DRIVE_GEAR_RATIO);
    ...
    public SwerveModuleState getState() {
        return new SwerveModuleState(
                Conversions.falconToMPS(mDriveMotor.getSelectedSensorVelocity(), SwerveConstants.WHEEL_CIRCUMFRENCE,
    ...
    public SwerveModulePosition getPosition() {
        return new SwerveModulePosition(
                Conversions.falconToMeters(mDriveMotor.getSelectedSensorPosition(), SwerveConstants.WHEEL_CIRCUMFRENCE,
                        SwerveConstants.DRIVE_GEAR_RATIO),
                getAngle());
    }
