...
public class DriveSubsystem extends SubsystemBase {
    ...
    private PIDController m_balancePID = new PIDController(SwerveConstants.GAINS_BALANCE.kP,
            SwerveConstants.GAINS_BALANCE.kI, SwerveConstants.GAINS_BALANCE.kD);
    ...
    public DriveSubsystem() {
        ...
        swerveOdometry = new SwerveDriveOdometry(SwerveConstants.SWERVE_DRIVE_KINEMATICS, getYaw(),
                getModulePositions());
    }
    ...
    public void periodic() {
        ...
        m_balancePID.setTolerance(SwerveConstants.BALANCE_TOLERANCE);
    ...
    public void zeroGyro() {
        m_gyro.setYaw(0);
        // swerveOdometry.resetPosition(getYaw(), getModulePositions(), new Pose2d(0.0,
    ...
    public SequentialCommandGroup followTrajectoryCommand(PathPlannerTrajectory path1, boolean isFirstPath) {
        ...
        return new SequentialCommandGroup(
                new InstantCommand(() -> {
                    ...
                    if (isFirstPath) {
                        PathPlannerTrajectory transformed = PathPlannerTrajectory.transformTrajectoryForAlliance(path1,
